...
function descriptionHtml(
  ...
  return `
    <section data-pdf-block="description">
      ${sectionTitle(
...
function materialsHtml(
  ...
  return `
    <section data-pdf-block="materials">
      ${sectionTitle(
      ...
      <div class="materials table-${esc(appearance.tableStyle)}">
        ${materials
          .map(
            (material, index) => `
              <article class="material-row" data-material-row>
...
function totalsHtml(order: WorkOrder) {
  ...
  return `
    <section class="totals-section" data-pdf-block="totals">
...
function signatureHtml(
  ...
  return `
    <section class="signature-section" data-pdf-block="signature">
      ${sectionTitle(
