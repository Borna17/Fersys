...
function CustomerTypeIcon({
  ...
  if (type === 'company' && logo) {
    return (
      <div className={`${base} border border-slate-700 bg-white`}>
        <img
          src={logo}
  ...
  if (type === 'company') {
    return (
      <div className={`${base} bg-violet-500/15 text-violet-300`}>
        <Building2 size={size === 'lg' ? 26 : 21} />
      </div>
    )
  }
  ...
  if (type === 'building') {
    return (
      <div className={`${base} bg-amber-500/15 text-amber-300`}>
        <Building size={size === 'lg' ? 26 : 21} />
      </div>
    )
  }

  return (
    <div className={`${base} bg-blue-500/15 text-blue-300`}>
      <UserRound size={size === 'lg' ? 26 : 21} />
    </div>
  )
}
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
                Osobe, tvrtke, obrti i zgrade na jednom mjestu.
              </p>
            </div>
        ...
        <section className="rounded-3xl border border-slate-800 bg-slate-900 p-3 sm:p-4">
          ...
          <div className="relative mt-3 sm:hidden">
            <select
              ...
              className="h-11 w-full appearance-none rounded-2xl bg-slate-800 px-4 pr-10 text-sm font-bold text-white outline-none"
            >
          ...
          <div className="mb-3 flex items-center justify-between">
            <div>
              ...
              <h2 className="mt-1 text-lg font-black text-white">
                {filteredCustomers.length} prikazano
              </h2>
            </div>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      <InfoLine
                        icon={<Phone size={14} />}
                        value={customer.phone || 'Bez telefona'}
                      />
                      <InfoLine
                        icon={<MapPin size={14} />}
                        value={customer.city || 'Bez grada'}
                      />
                    </div>
          ...
          <div className="max-h-[96dvh] w-full overflow-y-auto rounded-t-[2rem] border-t border-slate-700 bg-slate-900 shadow-2xl sm:max-w-3xl sm:rounded-3xl sm:border">
            <div className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-800 bg-slate-900/98 px-4 py-4 backdrop-blur-xl sm:px-6 sm:py-5">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="grid h-11 w-11 place-items-center rounded-2xl bg-slate-800 text-slate-400 active:scale-95"
            ...
            <form onSubmit={handleAddCustomer} className="p-4 pb-28 sm:p-6 sm:pb-6">
              <div>
                ...
                <div className="mt-3 grid grid-cols-3 gap-2">
                  <TypeButton
                    ...
                    onClick={() => selectCustomerType('person')}
                  ...
                  <TypeButton
                    active={customerType === 'building'}
                    onClick={() => selectCustomerType('building')}
              ...
              <div className="mt-6 hidden border-t border-slate-800 pt-5 sm:flex sm:justify-end sm:gap-3">
                <button
                  type="button"
                  onClick={closeModal}
                  className="min-h-12 rounded-2xl bg-slate-800 px-6 font-black text-slate-300"
                >
                  Odustani
                </button>
