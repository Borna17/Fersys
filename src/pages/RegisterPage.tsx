          ...
          {success ? (
            ...
            >
              ...
              <button
                ...
                className="flex min-h-13 w-full items-center justify-center rounded-2xl bg-gradient-to-r from-violet-600 to-blue-600 px-5 py-3 font-bold text-white shadow-lg shadow-violet-600/20 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isSubmitting
                  ? 'Izrada računa...'
                  : 'Registriraj tvrtku'}
