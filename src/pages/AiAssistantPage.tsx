...
export function AiAssistantPage() {
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-150px)] w-full max-w-[1500px] flex-col">
      <div className="flex flex-col gap-5 border-b border-slate-800 pb-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-slate-400">
            Govori ili piši. Pomoćnik prvo priprema radnju, provjerava datum, radni dan i zauzetost, a zatim traži tvoju potvrdu.
          </p>
        </div>
        ...
        <button
          ...
          className="flex h-11 items-center justify-center gap-2 rounded-xl bg-slate-800 px-4 text-sm font-bold text-slate-300 transition hover:bg-slate-700 hover:text-white"
        >
          <Trash2 size={17} />
          Novi razgovor
        </button>
      ...
      <div className="mt-6 grid min-h-0 flex-1 grid-cols-1 gap-6 xl:grid-cols-[1fr_340px]">
        <div className="flex min-h-[650px] flex-col overflow-hidden rounded-3xl border border-slate-800 bg-slate-900">
          ...
          <form
            ...
            className="border-t border-slate-800 bg-slate-950/40 p-3 sm:p-4"
          >
            ...
            <div className="mt-4 space-y-3">
              {[
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-slate-800/70 px-4 py-3 text-left text-sm leading-6 text-slate-300 transition hover:bg-slate-800 hover:text-white"
                >
                  {example}
                </button>
              ))}
